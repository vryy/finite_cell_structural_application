...
namespace Kratos
{
    ...
    KRATOS_DEFINE_APPLICATION_VARIABLE(FINITE_CELL_STRUCTURAL_APPLICATION, double, FORCE_MAGNITUDE )
    KRATOS_DEFINE_APPLICATION_VARIABLE(FINITE_CELL_STRUCTURAL_APPLICATION, double, PHYSICAL_STRESS_OFFSET_PARAMETER ) // beta
    KRATOS_DEFINE_APPLICATION_VARIABLE(FINITE_CELL_STRUCTURAL_APPLICATION, double, STRESS_STABILIZATION )
    KRATOS_DEFINE_APPLICATION_VARIABLE(FINITE_CELL_STRUCTURAL_APPLICATION, int, GHOST_PENALTY_STABILIZATION_ORDER)
    KRATOS_DEFINE_APPLICATION_VARIABLE(FINITE_CELL_STRUCTURAL_APPLICATION, double, GHOST_PENALTY_STABILIZATION_FACTOR)
    ...
    */
    class KRATOS_API(FINITE_CELL_STRUCTURAL_APPLICATION) KratosFiniteCellStructuralApplication : public KratosApplication
    {
    public:
        ///@name Type Definitions
        ///@{
